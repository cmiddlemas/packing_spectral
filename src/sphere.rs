...
impl SphereConfig<U2> {
    pub fn from_file(_path: &PathBuf) -> SphereConfig<U2> {
        unimplemented!()
    }
}

impl Config for SphereConfig<U2> {
    fn get_reciprocal_cell(&self) -> &[f64] {unimplemented!()}
    fn one_wavevector(&self, _q: &[f64], _val: &mut f64) {unimplemented!()}
    fn sf_one_wavevector(&self, _q: &[f64], _val: &mut f64) {unimplemented!()}
    fn get_dimension(&self) -> usize {unimplemented!()}
    fn get_n_points(&self) -> usize {unimplemented!()}
    fn get_vol(&self) -> f64 {unimplemented!()}
}
